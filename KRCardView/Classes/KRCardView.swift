...
public protocol KRCardView {
    ...
    func didToogleKRCardView(cardViewController: CardViewController, cardVisible: Bool)
}
...
extension KRCardView where Self: UIViewController {
    ...
    public func cardVisible() -> Bool {
        return self.cardViewController.cardVisible
    }
    
    public func toogleKRCardView() {
        self.animationTransitionIfNeeded(state: nextState, duration: 0.9)
    }
    
    public func didToogleKRCardView(cardViewController: CardViewController, cardVisible: Bool) {
    ...
    func animationTransitionIfNeeded(state: CardState, duration: TimeInterval) {
        ...
        var frameAnimator: UIViewPropertyAnimator {
            ...
            animator.addCompletion { _ in
                ...
                bottomView.didToogleKRCardView(cardViewController: bottomView.cardViewController, cardVisible: bottomView.cardViewController.cardVisible)
            }
